...
<script src="<?php echo SITE; ?>/js/plugins/plugins.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/datepicker.min.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/bootstrap.min.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/bootstrap.bundle.min.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/datepicker.es.min.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/multiple-select.js"></script>
<script src="<?php echo SITE; ?>/js/plugins/trumbowyg.min.js"></script>
