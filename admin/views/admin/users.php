...
<div class="col-sm-6">
	<a href="<?php echo SITE; ?>/user/0" class="btn btn_new"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Usuario</a>
</div>
<hr>
<div class="row custom_table">
    ...
    <?php 
    foreach ($app->get_users() as $user) { ?>
    	<div class="col-sm-12 table_element text-left" id="delitem<?php echo $user->ID; ?>">
    	    <div class="col-sm-1"><a href="<?php echo SITE.'/user/'.$user->ID; ?> " class="btn">#<?php echo $user->ID; ?></a></div>
    	    ...
    	    <div class="col-sm-2 actions_col">
    	    	...
    	    	<a href="<?php echo SITE.'/user/'.$user->ID; ?> " class="btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    	    </div>
    	</div>
    <?php } ?>
</div>
